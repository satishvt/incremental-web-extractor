    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('cricket', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/firstcricket/')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/firstcricket/")) & (result['href'].endswith('.html')):
