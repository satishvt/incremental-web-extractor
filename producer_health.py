    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('health', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/category/health')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/health/")) & (result['href'].endswith('.html')):
