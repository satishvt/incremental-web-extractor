    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('sports', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/category/sports')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/sports/")) & (result['href'].endswith('.html')):
