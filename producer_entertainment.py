    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('entertainment', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/category/entertainment')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/entertainment/")) & (result['href'].endswith('.html')):
