    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('business', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/category/business')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/business/")) & (result['href'].endswith('.html')):
