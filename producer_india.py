    ...
    for ptext in result_block:
        try:
            ...
            if statusc:
                ...
                try:
                    sendresult = producer.send('india', value=xyd_json)
                    try:
...
r = requests.get('https://www.firstpost.com/category/india')
...
for result in result_block:
    try:
        if (result['href'].startswith("https://www.firstpost.com/india/")) & (result['href'].endswith('.html')):
